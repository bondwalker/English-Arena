...
const QUESTION_BANK = {
  ...
  "health_wellbeing": { label: "Health & Wellbeing", questions: [
    ...
    {type:"odd_one_out",question:"Which sentence has a grammar mistake?",options:["She has been going to the gym three times a week.","He feels better since he started exercising regularly.","They walk to work every morning.","She have lost five kilos this month."],answer:"She have lost five kilos this month.",explanation:"Third person singular: 'She has lost five kilos this month.'"},
  ]},
...
function HostView({ onBack }) {
  ...
  // Publish initial room so students can find it before teacher loads questions
