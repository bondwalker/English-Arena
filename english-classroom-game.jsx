...
const QUESTION_BANK = {
  "travel_holidays": { label: "Travel & Holidays", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["She","packed","her","bags","the","night","before"],answer:"She packed her bags the night before",explanation:"Subject + past simple + object + time phrase."},
  ...
  "work_office": { label: "Work & the Office", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","sent","the","report","by","Friday"],answer:"she sent the report by Friday",explanation:"Subject + verb + object + time phrase."},
  ...
  "cooking_recipes": { label: "Cooking & Recipes", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["add","the","eggs","one","by","one"],answer:"add the eggs one by one",explanation:"Imperative + object + adverbial phrase."},
  ...
  "health_wellbeing": { label: "Health & Wellbeing", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["sleep","is","essential","for","good","health"],answer:"sleep is essential for good health",explanation:"Subject + is + adjective + prepositional phrase."},
  ...
  "technology_gadgets": { label: "Technology & Gadgets", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["you","should","back","up","your","files"],answer:"you should back up your files",explanation:"Subject + modal + phrasal verb + object."},
  ...
  "the_environment": { label: "The Environment", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["we","should","use","less","plastic"],answer:"we should use less plastic",explanation:"Subject + modal + verb + object."},
  ...
  "sports_fitness": { label: "Sports & Fitness", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","trains","every","day","after","work"],answer:"she trains every day after work",explanation:"Subject + verb + frequency + time phrase."},
  ...
  "family_life": { label: "Family Life", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["my","parents","got","married","in","a","small","church"],answer:"my parents got married in a small church",explanation:"Subject + verb + past participle + prepositional phrase."},
  ...
  "education_studying": { label: "Education & Studying", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["students","must","hand","in","work","on","time"],answer:"students must hand in work on time",explanation:"Subject + modal + phrasal verb + object + time phrase."},
  ...
  "money_banking": { label: "Money & Banking", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","opened","a","savings","account","last","year"],answer:"she opened a savings account last year",explanation:"Subject + past simple + object + time expression."},
  ...
  "shopping_fashion": { label: "Shopping & Fashion", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","always","checks","the","sale","section","first"],answer:"she always checks the sale section first",explanation:"Subject + frequency adverb + verb + object + adverb."},
  ...
  "music": { label: "Music", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["he","taught","himself","to","play","guitar"],answer:"he taught himself to play guitar",explanation:"Subject + reflexive verb + to + infinitive + object."},
  ...
  "social_media_internet": { label: "Social Media & the Internet", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","spends","too","much","time","on","her","phone"],answer:"she spends too much time on her phone",explanation:"Subject + verb + too much + noun + prepositional phrase."},
  ...
  "ambitions_goals": { label: "Ambitions & Goals", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","is","determined","to","make","a","difference"],answer:"she is determined to make a difference",explanation:"Subject + is determined to + infinitive + object."},
  ...
  "culture_traditions": { label: "Culture & Traditions", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["learning","about","other","cultures","helps","us"],answer:"learning about other cultures helps us",explanation:"Gerund phrase as subject + verb + object."},
  ...
  "films_tv": { label: "Films & TV", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["the","director","has","been","making","films","for","years"],answer:"the director has been making films for years",explanation:"Subject + present perfect continuous + object + for + duration."},
  ...
  "books_reading": { label: "Books & Reading", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","always","reads","before","bed"],answer:"she always reads before bed",explanation:"Subject + frequency adverb + verb + time phrase."},
  ...
  "home_housing": { label: "Home & Housing", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["we","moved","to","a","bigger","house","last","year"],answer:"we moved to a bigger house last year",explanation:"Subject + past simple + object + time phrase."},
  ...
  "food_restaurants": { label: "Food & Restaurants", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","asked","for","some","extra","bread"],answer:"she asked for some extra bread",explanation:"Subject + asked for + object."},
  ...
  "cities_travel": { label: "Cities & Travel", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["the","city","has","changed","a","lot","recently"],answer:"the city has changed a lot recently",explanation:"Subject + present perfect + object + adverb."},
  ...
  "science_discovery": { label: "Science & Discovery", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["the","experiment","was","repeated","three","times"],answer:"the experiment was repeated three times",explanation:"Subject + passive verb + frequency."},
  ...
  "friendship": { label: "Friendship", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["a","true","friend","always","tells","you","the","truth"],answer:"a true friend always tells you the truth",explanation:"Subject + frequency adverb + verb + object."},
  ...
  "celebrations_parties": { label: "Celebrations & Parties", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["everyone","agreed","it","was","the","best","party"],answer:"everyone agreed it was the best party",explanation:"Main clause + embedded clause."},
  ...
  "emotions_feelings": { label: "Emotions & Feelings", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","was","relieved","to","hear","the","good","news"],answer:"she was relieved to hear the good news",explanation:"Subject + adjective + infinitive + object."},
  ...
  "language_communication": { label: "Language & Communication", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["learning","a","language","takes","time"],answer:"learning a language takes time",explanation:"Gerund phrase as subject + verb + object."},
  ...
  "news_current_affairs": { label: "News & Current Affairs", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["the","new","law","was","announced","yesterday"],answer:"the new law was announced yesterday",explanation:"Subject + passive verb + time adverb."},
  ...
  "hobbies_free_time": { label: "Hobbies & Free Time", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","takes","photographs","every","weekend"],answer:"she takes photographs every weekend",explanation:"Subject + verb + object + time phrase."},
  ...
  "nature_animals": { label: "Nature & Animals", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["many","species","are","at","risk","of","extinction"],answer:"many species are at risk of extinction",explanation:"Subject + verb + prepositional phrase."},
  ...
  "jobs_interviews": { label: "Jobs & Interviews", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","impressed","the","interviewers","with","her","confidence"],answer:"she impressed the interviewers with her confidence",explanation:"Subject + verb + object + prepositional phrase."},
  ...
  "past_memories": { label: "Past & Memories", questions: [
    ...
    {type:"rearrange",question:"Rearrange into a correct sentence:",words:["she","found","old","photos","while","sorting","her","things"],answer:"she found old photos while sorting her things",explanation:"Main clause + while + gerund clause."},
