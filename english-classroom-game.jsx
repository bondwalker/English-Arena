...
const QUESTION_BANK = {
  ...
  "sports_fitness": { label: "Sports & Fitness", questions: [
    ...
    {type:"multiple_choice",question:"Which sentence uses 'enough' correctly?",options:["She isn't strong enough to lift that weight.","She isn't enough strong to lift that weight.","She isn't strong to enough lift that weight.","She doesn't strong enough to lift that weight."],answer:"She isn't strong enough to lift that weight.",explanation:"'Enough' always comes after the adjective: 'strong enough', not 'enough strong'."},
